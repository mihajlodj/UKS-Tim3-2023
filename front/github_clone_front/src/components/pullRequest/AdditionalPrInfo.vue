<template>
    <div>
        ...
        <div ref="labels">
            ...
            <LabelsModal v-if="showModal['labels']" :x="modalX" :y="modalY" :w="modalW" :selectedLabels="labels" @closeModal="toggleModal('labels')" />
        </div>
        <hr class="muted" />
...
export default {
    ...
    props: ["chosenMilestone", "chosenAssignee", "chosenReviewers", "selectedLabels"],
