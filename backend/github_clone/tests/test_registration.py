...
def test_register_candidate_success():
    ...
    payload = {
        ...
        'email': 'milica.popovic720@gmail.com'
    }
...
def test_confirm_registration_success():
    username = 'abcd'
    code = '123456'
    user = User.objects.create_user(username=username, first_name=fake.first_name, last_name=fake.last_name, email='fake@email.com', password='MyPass123')
    user.save()
    assert User.objects.count() == 1
