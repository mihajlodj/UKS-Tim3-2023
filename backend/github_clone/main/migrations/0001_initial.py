# Generated by Django 4.2.7 on 2024-04-16 15:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(default=datetime.datetime(2024, 4, 16, 15, 38, 15, 383846, tzinfo=datetime.timezone.utc))),
                ...
                ('manager', models.ManyToManyField(blank=True, related_name='managed_issues', to='main.developer')),
            ],
        ),
        migrations.CreateModel(
            name='Milestone',
