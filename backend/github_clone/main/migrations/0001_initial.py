...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(default=datetime.datetime(2024, 4, 22, 11, 44, 14, 598232, tzinfo=datetime.timezone.utc))),
                ...
                ('manager', models.ManyToManyField(blank=True, null=True, related_name='managed_issues', to='main.developer')),
            ],
        ),
        migrations.CreateModel(
            name='Milestone',
