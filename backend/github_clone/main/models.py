...
class Event(models.Model):
    ...
    caused_by = models.ForeignKey(Developer, related_name='caused_events', on_delete=models.CASCADE)
    issue = models.ForeignKey('Issue', related_name='events', on_delete=models.CASCADE)
    milestone = models.ForeignKey('Milestone', related_name='events', on_delete=models.CASCADE)

    class Meta:
        abstract = True


class Assignment(models.Model, Event):
    pass
...
class Comment(models.Model, Event):
...
class ContentChanged(models.Model, Event):
